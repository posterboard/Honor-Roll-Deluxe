...
Date: 6/1/21
This is an improvement of Kush's Honor Roll OOP program. I have implemented the data validation function as well as the ability to run the program again. I have also removed the discipline infraction parts of the program.
*/
#include <iostream>
#include "Functions.h"
#include <string>
